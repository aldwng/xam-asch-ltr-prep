...
SAMPLE_PATH_PREFIX="/user/h_misearch/appmarket/lambdarank/sample/text/date=${day}"
...
${HADOOP} ${ZJY_CLUSTER} fs -get /user/h_misearch/appmarket/lambdarank/RankLib-1.0.0-mdf-2.11-SNAPSHOT.jar ${OUTPUT_PATH}/RankLib-1.0.0-mdf-2.11-SNAPSHOT.jar
