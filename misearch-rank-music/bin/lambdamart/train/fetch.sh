...
SAMPLE_PATH_PREFIX="/user/h_misearch/ai/music/lambdamart/sample/date=${day}"
...
${HADOOP} ${ZJY_CLUSTER} fs -get /user/h_misearch/ai/music/lambdamart/RankLib-1.0.0-mdf-2.11-SNAPSHOT.jar ${OUTPUT_PATH}/RankLib-1.0.0-mdf-2.11-SNAPSHOT.jar
