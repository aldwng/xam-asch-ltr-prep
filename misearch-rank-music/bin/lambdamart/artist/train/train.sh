...
then
  ...
  ${HADOOP} ${ZJY_CLUSTER} fs -put -f ${model} /user/h_misearch/ai/music/lambdamart_artist/model/model.txt
  ${HADOOP} ${ZJY_CLUSTER} fs -put -f ${model} /user/h_misearch/ai/music/lambdamart_artist/model/model.txt.${day}
