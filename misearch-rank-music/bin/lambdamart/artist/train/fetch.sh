...
SAMPLE_PATH_PREFIX="/user/h_misearch/ai/music/lambdamart_artist/sample/date=${day}"
TRAIN_PATH=${SAMPLE_PATH_PREFIX}/train
TEST_PATH=${SAMPLE_PATH_PREFIX}/test

OUTPUT_PATH="${BIN_DIR}/data_artist"
rm -rf ${OUTPUT_PATH}
mkdir ${OUTPUT_PATH}
...
${HADOOP} ${ZJY_CLUSTER} fs -get /user/h_misearch/ai/music/lambdamart/RankLib-1.0.0-mdf-2.11-SNAPSHOT.jar \
${OUTPUT_PATH}/RankLib-1.0.0-mdf-2.11-SNAPSHOT.jar
